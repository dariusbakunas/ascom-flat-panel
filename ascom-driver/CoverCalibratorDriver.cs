...
//
// ASCOM CoverCalibrator driver for EllumiGlowFlatPanel
//
...
namespace ASCOM.EllumiGlowFlatPanel
{
    //
    // Your driver's DeviceID is ASCOM.EllumiGlowFlatPanel.CoverCalibrator
    //
    // The Guid attribute sets the CLSID for ASCOM.EllumiGlowFlatPanel.CoverCalibrator
    // The ClassInterface/None attribute prevents an empty interface called
    // _EllumiGlowFlatPanel from being created and used as the [default] interface
    //
    ...
    /// ASCOM CoverCalibrator Driver for EllumiGlowFlatPanel.
    /// </summary>
    [Guid("9d4a2d8b-d739-4efb-be1a-0e97223ed8b2")]
    ...
    public class CoverCalibrator : ICoverCalibratorV1
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.EllumiGlowFlatPanel.CoverCalibrator";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "ASCOM CoverCalibrator Driver for EllumiGlowFlatPanel.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EllumiGlowFlatPanel"/> class.
        /// Must be public for COM registration.
        /// </summary>
        public CoverCalibrator()
        {
            tl = new TraceLogger("", "EllumiGlowFlatPanel");
